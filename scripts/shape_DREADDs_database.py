...
original_db_path = 'Data/MazeControl-DREADDs.db'
shaped_db_path = 'Data/MazeControl-DREADDs-Shaped.db'
...
conn = sqlite3.connect('Data/MazeControl-DREADDs-Shaped.db')
cursor = conn.cursor()

# Enter Rat IDs you want data for here
# create id list for subjects you want from database
subject_id = [81, 83, 84, 85, 86, 88, 89, 100, 106, 107, 108, 109, 110, 112, 113, 117, 119, 120, 122]
